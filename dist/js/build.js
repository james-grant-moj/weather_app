...
(function () {
    ...
    angular.module('weather_app').controller('main-controller', ['mainService', function (mainService) {
        var vm = this;
        console.log(test);
...
(function () {
    ...
    angular.module('weather_app').factory('mainService', ['$q', '$http', function ($q, $http) {
        var service = {};
